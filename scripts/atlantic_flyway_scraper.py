...
def schedule_daily_scraping():
    """Schedule the Atlantic Flyway scraper to run daily at 1:00 PM"""
    schedule.every().day.at("13:00").do(run_flyway_scraper)
    
    print("Atlantic Flyway scraper scheduled to run daily at 1:00 PM")
