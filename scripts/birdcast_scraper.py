...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('../logs/birdcast_scraper.log'),
...
class BirdCastScraper:
    ...
    def save_to_csv(self, data_list, filename='../data/birdcast_data.csv'):
    ...
    def save_to_json(self, data_list, filename='../data/birdcast_data.json'):
